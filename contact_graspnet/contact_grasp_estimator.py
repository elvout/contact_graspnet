...
class GraspEstimator:
    ...
    def extract_3d_cam_boxes(self, full_pc, pc_segments, min_size=0.3, max_size=0.6, verbose=True):
        """
    ...
    def predict_scene_grasps(self, sess, pc_full, pc_segments={}, local_regions=False, filter_grasps=False, forward_passes=1, verbose=True):
        """
        ...
        Keyword Arguments:
            ...
            verbose {bool} -- Whether to print number of generated grasps. (default: {True})
        Returns:
        ...
        if local_regions:
            pc_regions, _ = self.extract_3d_cam_boxes(pc_full, pc_segments, verbose=verbose)
        ...
        if filter_grasps:
            ...
            for k in segment_keys:
                ...
                if np.any(pc_segments[k]) and np.any(contact_pts[j]):
                    ...
                    if verbose and local_regions and np.any(pred_grasps_cam[k]):
